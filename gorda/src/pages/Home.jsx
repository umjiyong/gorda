        ...
        <>
            ...
            <section id="home">
                <div className="home_container">
                    ...
                    <a href="#donation" className="next_btn"><i className='bx bx-down-arrow-alt'></i></a>
                </div>
            </section>
            {/* End Home Section */}
            ...
            <section id="donation">
                <div className="donation_container">
                    <div className="donation_paragraph">
                        ...
                        <Link to="/dnlist"><button className="more_btn">더 알아보기</button></Link>
                    </div>
                    <a href="#poll" className="next_btn_2"><i className='bx bx-down-arrow-alt'></i></a>
                </div>
            </section>
            ...
            <section id="poll">
                <div className="poll_container">
                    <a href="#market" className="next_btn_3"><i className='bx bx-down-arrow-alt'></i></a>
            ...
            <section id="market">
                <div className="market_container">
                    ...
                    <a href="#home" className="next_btn_4"><i className='bx bx-up-arrow-alt'></i></a>
                </div>
            </section>
            <Footer />
        </>
