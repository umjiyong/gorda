...
function InstitutionDetail() {
    ...
    useEffect(() => {
        ...
        api.get(`api/foundation/${id.foundationIdx}`)
            .then((res) => {
        ...
        api.get(`api/donation/foundation/${id.foundationIdx}`)
            .then((res) => {
    ...
    return (
        <>
            ...
            <div className="institution_header">
                <div className="institution_image" style={{ backgroundImage: `url(${infos.foundationLogo})` }}></div>
                ...
                <div className="proposal_fx">
                    {donainfos &&
                        donainfos.map((item, key) => {
                            return <ProposalsItem donationName={item.donationName} donationSubject={item.donationSubject} donationLogo={item.donationLogo} donationIdx={item.donationIdx} />;
                        })}
                </div>
            </div>
        </>
