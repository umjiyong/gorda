...
function DonationDetailPage() {
    ...
    const [infos, setInfos] = useState({
        donationIdx: "f8ef9f089d14a37e9c540fd903a7543e661a80cdd63f3e3e2d00f79558c9b9da",
        foundationIdx: "1f42d8a83d86b4e2c91f0f66c3dc79b35bad41dce2ae86f996d48556b9c153df",
        donationLogo: "http://newsimg.hankookilbo.com/2017/01/09/201701091433285687_1.jpg",
        donationName: "기아대책",
    ...
    const handlePreventDefault = (e) => {
        api.post(`/api/donation_comment/regist`, {
    ...
    useEffect(() => {
        api.get(`api/donation/${id.campaignid}`)
            .then((res) => {
                setInfos(res.data.data);
                console.log("==", res.data.data.donationCurrentEth);
                console.log("==", res.data.data.donationTargetEth);

                setProgress((res.data.data.donationCurrentEth / res.data.data.donationTargetEth) * 100);
            })
            .catch((e) => {
                console.log(e);
            });
    ...
    useEffect(() => {
        if (infos) {
            api.get(`api/foundation/${infos.foundationIdx}`)
                .then((res) => {
        ...
        <>
            ...
            <div className="detail_container">
                <div className="box_notion">
                    <div className="notion_top">참여하면 Gorda에서 뱃지 SoulBound를 제공!</div>
                    <div className="notion_bottom">1ETH 이상 기부하는 분들께는 Honor 뱃지를 드립니다.</div>
                </div>
                ...
                <div className="eth_box">
                    ...
                    <div className="goal_eth">{web3.utils.fromWei(infos.donationTargetEth.toString(), "ether")} eth 목표</div>
                ...
                <div className="foundation">
                    ...
                    <div className="foundation_image" style={{ backgroundImage: `url(${infos.donationLogo})` }}></div>
                ...
                <div className="period">
                    모금기간: {infos.donationStartDate.substr(0, 10)} ~{infos.donationEndDate.substr(0, 10)}
                </div>
                        ...
                        <Box sx={style}>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="modalCost">
                                    ...
                                    {inputValue ? <div className="dollar">{/* ~$달러 {getETHPriceInUSD(ethPrice, inputValue)} */}</div> : ""}
                                </div>
